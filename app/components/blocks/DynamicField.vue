...
<template>
    <!-- INPUT ─────────────────────────────────────────────────────────────── -->
    <Input v-if="type === 'input'" :type="inputType" :placeholder="placeholder" :disabled="disabled"
        :model-value="(modelValue as string | number | undefined)" :class="cn(props.class)"
    ...
    <!-- COMBOBOX ───────────────────────────────────────────────────────────── -->
    <GCombobox v-else-if="type === 'combobox'" :model-value="(modelValue as string | undefined)" :disabled="disabled"
        v-model:open="comboboxOpen" :class="cn('w-full', props.class)"
        @update:model-value="emit('update:modelValue', $event as string)">
        <GComboboxAnchor>
            <GComboboxInput :placeholder="placeholder ?? 'Search…'" :display-value="comboboxDisplayValue" />
            <GComboboxTrigger>
        ...
        <GComboboxList>
            <GComboboxViewport>
                ...
                <GComboboxItem v-for="option in options" :key="option.value" :value="option.value"
