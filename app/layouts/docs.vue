...
const navSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'Carousel', path: '/docs/carousel' },
      { title: 'Chart', path: '/docs/chart' },
      { title: 'Checkbox', path: '/docs/checkbox' },
      { title: 'Collapsible', path: '/docs/collapsible' },
      { title: 'Combobox', path: '/docs/combobox' },
      { title: 'Command', path: '/docs/command' },
      { title: 'Context Menu', path: '/docs/context-menu' },
      { title: 'Dialog', path: '/docs/dialog' },
      { title: 'Drawer', path: '/docs/drawer' },
      { title: 'Dropdown', path: '/docs/dropdown' },
      { title: 'Empty', path: '/docs/empty' },
      { title: 'Field', path: '/docs/field' },
      { title: 'Form', path: '/docs/form' },
      { title: 'Hover Card', path: '/docs/hover-card' },
      { title: 'Input', path: '/docs/input' },
      { title: 'Input Group', path: '/docs/input-group' },
      { title: 'Input OTP', path: '/docs/input-otp' },
      { title: 'Item', path: '/docs/item' },
      { title: 'Kbd', path: '/docs/kbd' },
      { title: 'Label', path: '/docs/label' },
      { title: 'Menubar', path: '/docs/menubar' },
      { title: 'Native Select', path: '/docs/native-select' },
      { title: 'Navigation Menu', path: '/docs/navigation-menu' },
      { title: 'Number Field', path: '/docs/number-field' },
      { title: 'Pagination', path: '/docs/pagination' },
      { title: 'Pin Input', path: '/docs/pin-input' },
      { title: 'Popover', path: '/docs/popover' },
      { title: 'Progress', path: '/docs/progress' },
      { title: 'Radio Group', path: '/docs/radio-group' },
      { title: 'Range Calendar', path: '/docs/range-calendar' },
      { title: 'Resizable', path: '/docs/resizable' },
      { title: 'Scroll Area', path: '/docs/scroll-area' },
      { title: 'Select', path: '/docs/select' },
      { title: 'Separator', path: '/docs/separator' },
      { title: 'Sheet', path: '/docs/sheet' },
      { title: 'Sidebar', path: '/docs/sidebar' },
      { title: 'Skeleton', path: '/docs/skeleton' },
      { title: 'Slider', path: '/docs/slider' },
      { title: 'Sonner', path: '/docs/sonner' },
      { title: 'Spinner', path: '/docs/spinner' },
      { title: 'Stepper', path: '/docs/stepper' },
      { title: 'Switch', path: '/docs/switch' },
      { title: 'Table', path: '/docs/table' },
      { title: 'Tabs', path: '/docs/tabs' },
      { title: 'Tags Input', path: '/docs/tags-input' },
      { title: 'Textarea', path: '/docs/textarea' },
      { title: 'Toggle', path: '/docs/toggle' },
      { title: 'Toggle Group', path: '/docs/toggle-group' },
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'Select', path: '/docs/kit-select' },
    ],
  },
]
